#encoding: utf-8
class Admin::AdminsController < AdminController #要改AdminController？原本是applicationcontroller 
		def index
...
private        
        def admin_params
	        	params.require(:admin).permit( :name, :email, :password, :password_comfirmation, :isnotify )
        end
end
