...
private
	...
	def contact_params
params.require(:contact).permit(:isparent,:name,:birthday,:address,:email,:education,:majorin,:learningtype,:institute,:period,:certification,:certificationdetail,:level,:score,:purposedetail,{:weekness => []},{:bottleneck => []},{:availabletime => []},:tpclass,{:purpose => []},{:consultcourse =>[]},:phone )#,{:purpose => []} 
	end
	...
	def set_options
			...
			#諮詢課程
			@consultcourse = [['一對一真人教學','一對一真人教學'],['ebs不可能任務中心','ebs不可能任務中心'],['企業訓練課程','企業訓練課程'],['兒童英語課程','兒童英語課程']]
	end
end
